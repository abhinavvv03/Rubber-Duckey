...
Duckencoder: 1.0
Target: Windows 7
Description: This is a fun payload that changes the users mouse cursor to a loading sign, and shuts off every thing on there desktop that runs explorer (every thing in windows)
